...
namespace distributed
{
  ...
  void CloudantDBLayer::releaseGeneralPurposeLock(string const & entityName) {
   ...
   void CloudantDBLayer::getKeys(uint64_t store, std::vector<unsigned char *> & keysBuffer, std::vector<uint32_t> & keysSize, int32_t keyStartPosition, int32_t numberOfKeysNeeded, PersistenceError & dbError) {
    ...
    void CloudantDBLayer::getValues(uint64_t store, std::vector<char *> const & keyData, std::vector<uint32_t> const & keySize, std::vector<unsigned char *> & valueData, std::vector<uint32_t> & valueSize, PersistenceError & dbError) {
       SPLAPPTRC(L_DEBUG, "Inside getValues for store id " << store, "CloudantDBLayer");
    ...
    void CloudantDBLayer::putKVPairs(uint64_t store, std::vector<char *> const & keyData, std::vector<uint32_t> const & keySize, std::vector<unsigned char *> const & valueData, std::vector<uint32_t> const & valueSize, PersistenceError & dbError) {
       SPLAPPTRC(L_DEBUG, "Inside putKVPairs for store id " << store, "CloudantDBLayer");
    ...
    void CloudantDBLayer::hasKeys(uint64_t store, std::vector<char *> const & keyData, std::vector<uint32_t> const & keySize, std::vector<bool> & results, PersistenceError & dbError) {
       SPLAPPTRC(L_DEBUG, "Inside hasKeys for store id " << store, "CloudantDBLayer");
    ...
    void CloudantDBLayer::removeKeys(uint64_t store, std::vector<char *> const & keyData, std::vector<uint32_t> const & keySize, int32_t & totalKeysRemoved, PersistenceError & dbError) {
       SPLAPPTRC(L_DEBUG, "Inside removeKeys for store id " << store, "CloudantDBLayer");
